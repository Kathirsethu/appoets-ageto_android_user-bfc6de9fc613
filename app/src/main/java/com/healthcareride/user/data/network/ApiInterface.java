package com.healthcareride.user.data.network;
...
import com.healthcareride.user.data.network.model.Coupon;
...
import com.healthcareride.user.data.network.model.Rental;
